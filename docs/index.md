...
hero:
  ...
  tagline: Built on Axum, SeaORM, PostgreSQL, Redis, NATS, MeiliSearch, and Cloudflare R2-compatible object storage.
  actions:
    - theme: brand
      text: Get Started
...
features:
  ...
  - title: Background Workers
    details: NATS JetStream job queue with email delivery, user indexing, and cron jobs.
  - title: Full-text Search
    details: MeiliSearch integration with automatic user indexing and reindex support.
  - title: Rate Limiting
