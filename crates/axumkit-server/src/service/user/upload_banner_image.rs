...
use axumkit_constants::user_image_key;
use axumkit_dto::user::UploadUserImageRequest;
use axumkit_dto::user::UploadUserImageResponse;
...
pub async fn service_upload_banner_image(
    ...
    info!(
        "Uploading banner image: user_id={}, mime_type={}, size={} bytes",
    ...
    r2_client
        ...
        .await
        .map_err(|e| {
            error!("Failed to upload banner image to R2: {}", e);
    ...
    info!("Banner image uploaded successfully: {}", image_url);
