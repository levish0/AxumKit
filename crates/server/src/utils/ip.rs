...
/// dual-stack socket. Keeping a single canonical form across IP-based lookups and
...
mod tests {
    ...
    #[test]
    fn canonicalize_ip_maps_ipv4_mapped_ipv6_to_ipv4() {
    ...
    #[test]
    fn canonicalize_ip_preserves_genuine_ipv6() {
