...
use crate::service::groups::service_add_group_member;
...
pub async fn add_group_member(
    ...
    ValidatedJson(payload): ValidatedJson<AddGroupMemberRequest>,
) -> Result<GroupMemberResponse, Errors> {
    service_add_group_member(&state.db, payload, &session).await
}
