...
pub struct AddAclGroupMemberRequest {
    /// Target group
    pub group_id: Uuid,
    ...
    // same acl_group_members.reason column — one cap for every writer.
...
pub struct RemoveAclGroupMemberRequest {
...
pub struct ListAclGroupMembersRequest {
